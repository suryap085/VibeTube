...
class SearchVideosFragment : BaseSearchFragment() {
    ...
    override fun performSearch(query: String) {
        ...
        lifecycleScope.launch {
            try {
                ...
                Log.d(TAG, "Video search completed. Found ${videos.size} videos for query: '$query'")
                
            } catch (e: Exception) {
                Log.e(TAG, "Video search failed for query: '$query'", e)
